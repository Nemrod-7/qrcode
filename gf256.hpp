...
namespace gf256 {
    ...
    u8 sub (u8 a, u8 b) { return a ^ b; }
    u8 mul (u8 a, u8 b) { return a && b ? EXP[(LOG[a] + LOG[b])] : 0; }
...
// void generate_table() {
//     The QR code specification says to use byte-wise modulo 100011101 arithmetic (285 in decimal).
//     const int mod = 285;
//
